...
public class DragonAPINBTFix implements RfbClassTransformer {
    ...
    private static final byte[] NAME_BYTES = "Reika.DragonAPI.Instantiable.Data.Maps.MultiMap"
    ...
    public boolean shouldTransformClass(@NotNull ExtensibleClassLoader classLoader, @NotNull Context context,
        ...
        if ("Reika.DragonAPI.Instantiable.Data.Maps.MultiMap".equals(className)) return true;
            ...
            for (var insn : method.instructions.toArray()) {
                ...
                switch (mInsn.name) {
                    case "writeToNBT", "readFromNBT" -> {
                        if (!mInsn.owner.equals("Reika/DragonAPI/Instantiable/Data/Maps/MultiMap")) continue;
                        if (!mInsn.desc.equals(DESC_OG)) continue;
