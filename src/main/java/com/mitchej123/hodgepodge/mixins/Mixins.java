...
public enum Mixins implements IMixins {
    ...
    ONLY_LOAD_LANGUAGES_ONCE_PER_FILE(new MixinBuilder("Only load languages once per file")
            ...
            .setSide(Side.BOTH)
            .addMixinClasses("minecraft.MixinLanguageRegistry")
    ...
    CHANGE_CATEGORY_SPRINT_KEY(new MixinBuilder("Moves the sprint keybind to the movement category")
            ...
            .setSide(Side.CLIENT)
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinGameSettings_SprintKey")
    ...
    FIX_TOO_MANY_ALLOCATIONS_CHUNK_POSITION_INT_PAIR_OPTIFINE_INCOMPAT(new MixinBuilder("Stops MC from allocating too many ChunkPositionIntPair objects")
            ...
            .setSide(Side.BOTH)
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinWorldServer_FixAllocations")
            .setApplyIf(() -> FixesConfig.fixTooManyAllocationsChunkPositionIntPair)),
    ...
    FIX_CONTAINER_PUT_STACKS_IN_SLOTS(new MixinBuilder("Prevents crash if server sends container with wrong itemStack size")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinContainer")
            .setSide(Side.CLIENT)
    ...
    FIX_CONTAINER_SHIFT_CLICK_RECURSION(new MixinBuilder("Backports 1.12 logic for shift clicking slots to prevent recursion")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinContainer_FixShiftRecursion")
            .setSide(Side.BOTH)
    ...
    FIX_NETHANDLERPLAYCLIENT_HANDLE_SET_SLOT(new MixinBuilder("Prevents crash if server sends itemStack with index larger than client's container")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinNetHandlerPlayClient_FixHandleSetSlot")
            .setSide(Side.CLIENT)
    ...
    FIX_NETHANDLERLOGINSERVER_OFFLINEMODE(new MixinBuilder("Allows the server to assign the logged in UUID to the same username when online_mode is false")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinNetHandlerLoginServer_OfflineMode")
            .setSide(Side.SERVER)
    ...
    DISABLE_REALMS_BUTTON(new MixinBuilder("Disable Realms button in main menu")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinGuiMainMenu_DisableRealmsButton")
            .setSide(Side.CLIENT)
            .setApplyIf(() -> TweaksConfig.disableRealmsButton)
            .addTargetedMod(TargetedMod.VANILLA)),
    ADD_TIME_GET(new MixinBuilder("Add /time get command")
            .addMixinClasses("minecraft.MixinCommandTime")
            .addTargetedMod(TargetedMod.VANILLA)
    ...
    THROTTLE_ITEMPICKUPEVENT(new MixinBuilder("Throttle Item Pickup Event")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinEntityPlayer_ThrottlePickup")
            .setSide(Side.BOTH)
    ...
    ADD_THROWER_TO_DROPPED_ITEM(new MixinBuilder("Adds the thrower tag to all dropped EntityItems")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinEntityPlayer_ItemThrower")
            .setSide(Side.BOTH)
    ...
    SYNC_ITEM_THROWER_COMMON(new MixinBuilder("Synchonize from server to client the thrower and pickup delay of an item entity")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.packets.MixinS0EPacketSpawnObject_ItemThrower")
            .setSide(Side.BOTH)
    ...
    SYNC_ITEM_THROWER_CLIENT(new MixinBuilder("Synchonize from server to client the thrower and pickup delay of an item entity")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinNetHandlerPlayClient_ItemThrower")
            .setSide(Side.CLIENT)
            .setApplyIf(() -> FixesConfig.syncItemThrower)
            .addTargetedMod(TargetedMod.VANILLA)),
    ...
    FIX_REED_PLACING(new MixinBuilder("Fix placement of Sugar Canes")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinItemReed")
            .addTargetedMod(TargetedMod.VANILLA)
            .setSide(Side.BOTH)
    ...
    FIX_ENTITY_ATTRIBUTES_RANGE(new MixinBuilder("Fix Entity Attributes Range")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinNetHandlerPlayClient_FixEntityAttributesRange")
            .setSide(Side.CLIENT)
    ...
    ENDERMAN_BLOCK_GRAB_DISABLE(new MixinBuilder("Disable Endermen Grabbing Blocks")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinEntityEndermanGrab")
            .setSide(Side.BOTH)
    ...
    ENDERMAN_BLOCK_PLACE_DISABLE(new MixinBuilder("Disable Endermen Placing Held Blocks")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinEntityEndermanPlace")
            .setSide(Side.BOTH)
    ...
    LONGER_MESSAGES_CLIENT(new MixinBuilder("Longer Messages Client Side")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinGuiChat_LongerMessages")
            .setApplyIf(() -> true)
            .addTargetedMod(TargetedMod.VANILLA)
            .setSide(Side.CLIENT)),
    // config handled in mixin due to server->client config sync
    ...
    SPEEDUP_REMOVE_FORMATTING_CODES(new MixinBuilder("Speed up the vanilla method to remove formatting codes")
            .setPhase(Phase.EARLY)
            .setSide(Side.CLIENT)
            .addMixinClasses("minecraft.MixinEnumChatFormatting_FastFormat")
    ...
    SPEEDUP_GRASS_BLOCK_RANDOM_TICKING(new MixinBuilder("Speed up grass block random ticking")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinBlockGrass")
            .addTargetedMod(TargetedMod.VANILLA)
            .setSide(Side.BOTH)
    ...
    FORGE_FIX_CLASS_TYPO(new MixinBuilder("Fix a class name typo in MinecraftForge's initialize method")
            .setPhase(Phase.EARLY)
            .setSide(Side.BOTH)
            .addMixinClasses("forge.MixinMinecraftForge")
    ...
    FIX_LAG_ON_INVENTORY_SYNC(new MixinBuilder("Fix inventory sync lag")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinInventoryCrafting")
            .setSide(Side.BOTH)
    ...
    FIX_SKIN_MANAGER_CLIENT_WORLD_LEAK(new MixinBuilder("Fix skin manager client world leak")
            .setPhase(Phase.EARLY)
            .setSide(Side.CLIENT)
            .addMixinClasses("minecraft.MixinSkinManager$2")
    ...
    FIX_REDSTONE_TORCH_WORLD_LEAK(new MixinBuilder("Fix world leak in redstone torch")
            .setPhase(Phase.EARLY)
            .setSide(Side.BOTH)
            .addMixinClasses("minecraft.MixinBlockRedstoneTorch")
    ...
    OPTIMIZE_TEXTURE_LOADING(new MixinBuilder("Optimize Texture Loading")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.textures.client.MixinTextureUtil")
            .addTargetedMod(TargetedMod.VANILLA)
            .addExcludedMod(ANGELICA)
    ...
    OPTIMIZE_ASMDATATABLE_INDEX(new MixinBuilder("Optimize ASM DataTable Index")
            .setPhase(Phase.EARLY)
            .setSide(Side.BOTH)
            .addMixinClasses("fml.MixinASMDataTable")
    ...
    SQUASH_BED_ERROR_MESSAGE(new MixinBuilder("Stop \"You can only sleep at night\" message filling the chat")
            .addMixinClasses("minecraft.MixinNetHandlerPlayClient")
            .addTargetedMod(TargetedMod.VANILLA)
    ...
    CHUNK_SAVE_CME_DEBUG(new MixinBuilder("Add debugging code to Chunk Save CME")
            .setPhase(Phase.EARLY)
            .setSide(Side.BOTH)
            .addMixinClasses("minecraft.MixinNBTTagCompound")
    ...
    CROSSHAIR_THIRDPERSON(new MixinBuilder("Crosshairs thirdperson")
            .setPhase(Phase.EARLY)
            .addMixinClasses("forge.MixinGuiIngameForge_CrosshairThirdPerson")
            .setSide(Side.CLIENT)
    ...
    DONT_INVERT_CROSSHAIR_COLORS(new MixinBuilder("Don't invert crosshair colors")
            .setPhase(Phase.EARLY)
            .addMixinClasses("forge.MixinGuiIngameForge_CrosshairInvertColors")
            .setSide(Side.CLIENT)
    ...
    FIX_OPENGUIHANDLER_WINDOWID(new MixinBuilder("Fix OpenGuiHandler")
            .setPhase(Phase.EARLY)
            .setSide(Side.BOTH)
            .addMixinClasses("fml.MixinOpenGuiHandler")
    ...
    FIX_KEYBIND_CONFLICTS(new MixinBuilder("Trigger all conflicting keybinds")
            ...
            .setApplyIf(() -> FixesConfig.triggerAllConflictingKeybindings && !doesResourceExist("committee/nova/mkb/ModernKeyBinding.class"))
            .addTargetedMod(TargetedMod.VANILLA)),
    REMOVE_SPAWN_MINECART_SOUND(new MixinBuilder("Remove sound when spawning a minecart")
            .setPhase(Phase.EARLY)
            .setSide(Side.CLIENT)
            .addMixinClasses("minecraft.MixinWorldClient")
            .addTargetedMod(TargetedMod.VANILLA)
    ...
    MACOS_KEYS_TEXTFIELD_SHORTCUTS(new MixinBuilder("Macos use CMD to copy/select/delete text")
            .addMixinClasses("minecraft.MixinGuiTextField")
            .addTargetedMod(TargetedMod.VANILLA)
            .setApplyIf(() -> System.getProperty("os.name").toLowerCase().contains("mac") && TweaksConfig.enableMacosCmdShortcuts)
            .setPhase(Phase.EARLY)
            .setSide(Side.CLIENT)),
    FIX_FONT_RENDERER_LINEWRAP_RECURSION(new MixinBuilder("Replace recursion with iteration in FontRenderer line wrapping code")
            .addMixinClasses("minecraft.MixinFontRenderer")
            .addTargetedMod(TargetedMod.VANILLA)
    ...
    BED_MESSAGE_ABOVE_HOTBAR(new MixinBuilder("Bed Message Above Hotbar")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinBlockBed")
            .setSide(Side.BOTH)
    ...
    CHANGE_MAX_NETWORK_NBT_SIZE_LIMIT(new MixinBuilder("Modify the maximum NBT size limit as received from network packets")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinPacketBuffer")
            .setSide(Side.BOTH)
    ...
    DISABLE_CREATIVE_TAB_ALL_SEARCH(new MixinBuilder("Disable the creative tab with search bar")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinGuiContainerCreative")
            .setSide(Side.CLIENT)
    ...
    MODERN_PICK_BLOCK(new MixinBuilder("Allows pick block to pull items from your inventory")
            ...
            .setSide(Side.CLIENT)
            .setPhase(Phase.EARLY)
            .addMixinClasses("forge.MixinForgeHooks_ModernPickBlock")
    ...
    FIX_NEGATIVE_KELVIN(new MixinBuilder("Fix the local temperature can go below absolute zero")
            ...
            .setSide(Side.BOTH)
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinBiomeGenBase")
    ...
    SPIGOT_EXTENDED_CHUNKS(new MixinBuilder("Spigot-style extended chunk format to remove the 2MB chunk size limit")
            ...
            .setSide(Side.BOTH)
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinRegionFile")
    ...
    FIX_CASE_COMMAND(new MixinBuilder("Fix the command handler not allowing you to run commands typed in any case")
            ...
            .setSide(Side.BOTH)
            .addTargetedMod(TargetedMod.VANILLA)
            .addMixinClasses("minecraft.MixinCommandHandler_CommandFix")
    ...
    ADD_MOD_CONFIG_SEARCHBAR(new MixinBuilder("Adds a search bar to the mod config GUI")
            .setPhase(Phase.EARLY)
            .setSide(Side.CLIENT)
            .addMixinClasses("fml.MixinGuiConfig")
    ...
    FIX_CHAT_OPEN_LINK(new MixinBuilder("Fix the vanilla method to open chat links not working for every OS")
            ...
            .setSide(Side.CLIENT)
            .addTargetedMod(TargetedMod.VANILLA)
            .addMixinClasses("minecraft.MixinGuiChat_OpenLinks")
    ...
    FIX_BUKKIT_PLAYER_CONTAINER(new MixinBuilder("Fix Bukkit BetterQuesting crash")
            .setPhase(Phase.EARLY)
            .setSide(Side.BOTH)
            .addTargetedMod(TargetedMod.BUKKIT)
            .addMixinClasses("minecraft.MixinContainerPlayer")
    ...
    FIX_BUKKIT_FIRE_SPREAD_NPE(new MixinBuilder("Fix vanilla fire spread sometimes causing NPE on thermos")
            ...
            .setPhase(Phase.EARLY)
            .setSide(Side.BOTH)
            .addMixinClasses("minecraft.MixinBlockFireSpread")
            .setApplyIf(() -> FixesConfig.fixFireSpread)),
    MEMORY_FIXES_CLIENT(new MixinBuilder("Memory fixes")
            .setPhase(Phase.EARLY)
            .setSide(Side.CLIENT)
            .addTargetedMod(TargetedMod.VANILLA)
            .addMixinClasses("memory.MixinFMLClientHandler")
    ...
    EMBED_BLOCKIDS(new MixinBuilder("Embed IDs directly in the objects, to accelerate lookups")
            ...
            .setSide(Side.BOTH)
            .addTargetedMod(TargetedMod.VANILLA)
            .addExcludedMod(FASTCRAFT)
            .addExcludedMod(BUKKIT)
            .addMixinClasses(
    ...
    CANCEL_NONE_SOUNDS(new MixinBuilder("Skips playing empty sounds.")
            ...
            .setSide(Side.BOTH)
            .addTargetedMod(TargetedMod.VANILLA)
            .addMixinClasses("minecraft.shutup.MixinWorld")
    ...
    MEMORY_FIXES_IC2(new MixinBuilder("Removes allocation spam from the Direction.applyTo method")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .addMixinClasses("ic2.MixinDirection_Memory")
            .setApplyIf(() -> FixesConfig.enableMemoryFixes)
    ...
    PREVENT_LAVA_CHUNK_LOADING(new MixinBuilder("Prevent lava blocks from loading chunks")
            .setPhase(Phase.EARLY)
            .setSide(Side.BOTH)
            .addMixinClasses("minecraft.MixinBlockStaticLiquid")
    ...
    FIX_GLASS_BOTTLE_NON_WATER_BLOCKS(new MixinBuilder("Fix Glass Bottles filling with Water from some other Fluid blocks")
            .setPhase(Phase.EARLY)
            .setSide(Side.BOTH)
            .addMixinClasses("minecraft.MixinItemGlassBottle")
    ...
    FIX_IOOBE_RENDER_DISTANCE(new MixinBuilder("Fix out of bounds render distance when Optifine/Angelica is uninstalled")
            .setPhase(Phase.EARLY)
            .setSide(Side.CLIENT)
            .addExcludedMod(OPTIFINE)
            .addExcludedMod(ANGELICA)
            .addExcludedMod(FALSETWEAKS)
            .addTargetedMod(TargetedMod.VANILLA)
            .setApplyIf(() -> true)
    ...
    BETTER_MOD_LIST(new MixinBuilder("Better Mod List")
            ...
            .setApplyIf(() -> TweaksConfig.betterModList && !doesResourceExist("com/enderio/core/common/transform/EnderCoreTransformerClient.class"))
            .addTargetedMod(TargetedMod.VANILLA)),
    FIX_EGG_PARTICLE(new MixinBuilder("Use correct egg particles instead of snowball ones (MC-7807)")
            .setPhase(Phase.EARLY)
            .setSide(Side.CLIENT)
            .addMixinClasses("minecraft.MixinEntityEgg")
    ...
    IC2_HOVER_MODE_FIX(new MixinBuilder("IC2 Hover Mode Fix")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .addMixinClasses("ic2.MixinIc2QuantumSuitHoverMode")
    ...
    IC2_CROP_TRAMPLING_FIX(new MixinBuilder("IC2 Crop Trampling Fix")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .addMixinClasses("ic2.MixinIC2TileEntityCrop")
    ...
    IC2_CELL(new MixinBuilder("No IC2 Cell Consumption in tanks")
            .addMixinClasses("ic2.MixinIC2ItemCell")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    DAMAGE_INDICATORS_UPDATE_CHECK(new MixinBuilder("Yeet Damage Indicators Update Check")
            .setPhase(Phase.LATE)
            .setSide(Side.CLIENT)
            .addMixinClasses("damageindicators.MixinDIClientProxy")
            .setApplyIf(() -> FixesConfig.removeUpdateChecks)
            .addTargetedMod(TargetedMod.DAMAGE_INDICATORS)),
    ...
    THREADED_THAUMCRAFT_MAZE_SAVING(new MixinBuilder("Threaded Thaumcraft Maze Saving")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .addMixinClasses("thaumcraft.MixinMazeHandler_threadedIO")
            .setApplyIf(() -> TweaksConfig.threadedWorldDataSaving)
    ...
    FIX_WORLD_COORDINATE_HASHING_METHOD(new MixinBuilder("Implement a proper hashing method for WorldCoordinates")
            .addMixinClasses("thaumcraft.MixinWorldCoordinates")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    FIX_THAUMCRAFT_VIS_DUPLICATION(new MixinBuilder("Fix Thaumcraft Vis Duplication")
            .addMixinClasses("thaumcraft.MixinTileWandPedestal_VisDuplication")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    FIX_NULL_HANDLING_ITEMWISPESSENCE_CLIENT(new MixinBuilder("Fix handling of null stacks in ItemWispEssence")
            .addMixinClasses("thaumcraft.MixinItemWispEssence_Client")
            .setPhase(Phase.LATE)
            .setSide(Side.CLIENT)
    ...
    FIX_NULL_HANDLING_ITEMWISPESSENCE_BOTH(new MixinBuilder("Fix handling of null stacks in ItemWispEssence")
            .addMixinClasses("thaumcraft.MixinItemWispEssence_Both")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .setApplyIf(() -> FixesConfig.fixNullHandlingItemWispEssence)
            .addTargetedMod(TargetedMod.THAUMCRAFT)),
    ...
    FIX_QUICKSAND_XRAY(new MixinBuilder("Fix Xray through block without collision boundingBox")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .addMixinClasses("biomesoplenty.MixinBlockMud_FixXray")
            .setApplyIf(() -> FixesConfig.fixPerspectiveCamera)
    ...
    COFH_REMOVE_TE_CACHE(new MixinBuilder("Remove CoFH tile entity cache")
            .addMixinClasses("minecraft.MixinWorld_CoFH_TE_Cache")
            .setSide(Side.BOTH)
    ...
    COFH_IMPROVE_BREAKBLOCK(new MixinBuilder("Improve CoFH breakBlock method to support mods")
            .addMixinClasses("cofhcore.MixinBlockHelper")
            .setPhase(Phase.EARLY)
            .setSide(Side.CLIENT)
            .addTargetedMod(TargetedMod.COFH_CORE)
    ...
    DISARM_SACRED_TREE(new MixinBuilder("Prevents Sacred Rubber Tree Generation")
            .addMixinClasses("minefactoryreloaded.MixinBlockRubberSapling")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .addTargetedMod(TargetedMod.MINEFACTORY_RELOADED)
    ...
    MFR_IMPROVE_BLOCKSMASHER(new MixinBuilder("Improve MFR block smasher")
            .addMixinClasses("minefactoryreloaded.MixinTileEntityBlockSmasher")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .addTargetedMod(TargetedMod.MINEFACTORY_RELOADED)
            .setApplyIf(() -> TweaksConfig.improveMfrBlockSmasher)),
    MFR_IMPROVE_BLOCKBREAKER(new MixinBuilder("Improve MFR block breaker")
            .addMixinClasses("minefactoryreloaded.MixinTileEntityBlockBreaker")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .addTargetedMod(TargetedMod.MINEFACTORY_RELOADED)
    ...
    MPS_PREVENT_ME_ENERGY_SYPHON(new MixinBuilder("Prevent MPS from charging and draining ME from Inventory")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .addMixinClasses("mps.MixinElectricAdapterME")
    ...
    FIX_BETTERHUD_HEARTS_FREEZE(new MixinBuilder("Fix better HUD freezing the game when trying to render high amounts of hp")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .addMixinClasses("betterhud.MixinHealthRender")
    ...
    FIX_LOTR_FURNACE_ERROR(new MixinBuilder("Patches lotr to work with the vanilla furnace speedup")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .addMixinClasses("lotr.MixinLOTRRecipes")
            .setApplyIf(() -> SpeedupsConfig.speedupVanillaFurnace)
            .addTargetedMod(TargetedMod.VANILLA)
            .addTargetedMod(TargetedMod.GTNHLIB)
            .addTargetedMod(TargetedMod.LOTR)),
    ...
    FIX_JOURNEYMAP_JUMPY_SCROLLING(new MixinBuilder("Fix Journeymap jumpy scrolling in the waypoint manager")
            .setPhase(Phase.LATE)
            .setSide(Side.CLIENT)
            .addMixinClasses("journeymap.MixinWaypointManager")
    ...
    FIX_DRUM_EATING_CELLS(new MixinBuilder("Fix extra utilities drums eating ic2 cells and forestry capsules")
            .addMixinClasses("extrautilities.MixinBlockDrum")
            .setSide(Side.BOTH)
            .setPhase(Phase.LATE)
    ...
    FIX_GREENSCREEN_MICROBLOCKS(new MixinBuilder("Fix extra utilities Lapis Caelestis microblocks")
            .addMixinClasses("extrautilities.MixinFullBrightMicroMaterial")
            .setSide(Side.CLIENT)
            .setPhase(Phase.LATE)
    ...
    FIX_LAST_MILLENIUM_RAIN(new MixinBuilder("Remove rain from the Last Millenium (Extra Utilities)")
            .addMixinClasses("extrautilities.MixinChunkProviderEndOfTime")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    FIX_LAST_MILLENIUM_CREATURES(new MixinBuilder("Remove creatures from the Last Millenium (Extra Utilities)")
            .addMixinClasses("extrautilities.MixinWorldProviderEndOfTime")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    FIX_FLUID_RETRIEVAL_NODE(new MixinBuilder("Prevent fluid retrieval node from voiding (Extra Utilities)")
            .addMixinClasses("extrautilities.MixinFluidBufferRetrieval")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    FIX_FILING_CABINET_DUPE(new MixinBuilder("Caps hotkey'd stacks to their maximum stack size in filing cabinets")
            .addMixinClasses("extrautilities.MixinContainerFilingCabinet")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    FIX_FILTER_DUPE(new MixinBuilder("Prevent hotkeying other items onto item filters while they are open")
            .addMixinClasses("extrautilities.MixinContainerFilter")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    CONFIGURABLE_ENDERQUARRY_ENERGY(new MixinBuilder("Ender Quarry energy storage override")
            .addMixinClasses("extrautilities.MixinTileEntityEnderQuarry")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    FIX_ENDERQUARRY_FREEZE(new MixinBuilder("Fix Ender Quarry freezes randomly")
            .addMixinClasses("extrautilities.MixinTileEntityEnderQuarry_FixFreeze")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    FIX_HEALING_AXE_HEAL(new MixinBuilder("Fix the healing axe not healing entities when attacking them")
            .addMixinClasses("extrautilities.MixinItemHealingAxe")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    FIX_CHEST_COMPARATOR_UPDATE(new MixinBuilder("Fix Extra Utilities chests not updating comparator redstone signals when their inventories change")
            .addMixinClasses("extrautilities.MixinExtraUtilsChest")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    FIX_ETHERIC_SWORD_UNBREAKABLE(new MixinBuilder("Make Etheric Sword truly unbreakable")
            .addMixinClasses("extrautilities.MixinItemEthericSword")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    FIX_ENDER_COLLECTOR_CRASH(new MixinBuilder("Prevent Extra Utilities Ender Collector from inserting into auto-dropping Blocks that create a crash-loop")
            .addMixinClasses("extrautilities.MixinTileEnderCollector")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
    ...
    FIX_GLIBYS_VC_THREAD_SHUTDOWN_CLIENT(new MixinBuilder("Fix Gliby's voice chat not shutting down its client thread cleanly")
            .addMixinClasses("glibysvoicechat.MixinClientNetwork")
            .setPhase(Phase.LATE)
            .setSide(Side.CLIENT)
    ...
    FIX_GLIBYS_VC_THREAD_SHUTDOWN_SERVER(new MixinBuilder("Fix Gliby's voice chat not shutting down its server thread cleanly")
            .addMixinClasses("glibysvoicechat.MixinVoiceChatServer")
            .setPhase(Phase.LATE)
            .setSide(Side.BOTH)
            .setApplyIf(() -> FixesConfig.fixGlibysVoiceChatThreadStop)
            .addTargetedMod(TargetedMod.GLIBYS_VOICE_CHAT)),
    ...
    PORTALGUN_FIX_URLS(new MixinBuilder("Fix URLs used to download the sound pack")
            .addMixinClasses("portalgun.MixinThreadDownloadResources")
            .addTargetedMod(TargetedMod.PORTAL_GUN)
    ...
    BIBLIOCRAFT_PATH_SANITIZATION_FIX(new MixinBuilder("Path sanitization fix")
            .addMixinClasses("bibliocraft.MixinPathSanitization")
            .setPhase(Phase.LATE)
            .setSide((Side.BOTH))
    ...
    ASP_RECIPE_FIX(new MixinBuilder("MT Core recipe fix")
            .addMixinClasses("advancedsolarpanels.MixinAdvancedSolarPanel")
    ...
    DISABLE_CHUNK_TERRAIN_GENERATION(new MixinBuilder("Disable chunk terrain generation")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinChunkProviderServer_DisableTerrain")
            .addTargetedMod(TargetedMod.VANILLA)
            .setSide(Side.BOTH)
    ...
    DISABLE_MODDED_CHUNK_POPULATION(new MixinBuilder("Disable all other mod chunk population (e.g. Natura clouds")
            .setPhase(Phase.EARLY)
            .addMixinClasses("minecraft.MixinChunkProviderServer_DisableModGeneration")
            .addTargetedMod(TargetedMod.VANILLA)
            .setSide(Side.BOTH)
