...
public enum Mixins {
    ...
    LONGER_CHAT(
        new Builder("Longer Chat")
            .setPhase(Phase.EARLY)
            .addMixinClass("minecraft.MixinGuiNewChat_LongerChat")
            .setSide(Side.CLIENT)
            .setApplyIf(() -> Common.config.longerChat)
            .addTargetedMod(TargetedMod.VANILLA)),
    TRANSPARENT_CHAT(
        new Builder("Transparent Chat")
            .addMixinClass("minecraft.MixinGuiNewChat_TransparentChat")
            .setSide(Side.CLIENT)
    ...
    FIX_OPTIFINE_CHUNKLOADING_CRASH(
        new Builder("Fix Optifine Chunkloading Crash")
            ...
            .addMixinClasses(Arrays.asList("minecraft.MixinGameSettings", "minecraft.MixinGuiVideoSettings"))),
    ...
    CROSSHAIR_THIRDPERSON(
        new Builder("Crosshairs Thirdperson")
            .setPhase(Phase.EARLY)
            .addMixinClass("forge.MixinGuiIngameForge")
            .setSide(Side.CLIENT)
    ...
    HIDE_POTION_PARTICLES(
        new Builder("Hide Potion Particles")
            .setPhase(Phase.EARLY)
            .addMixinClass("minecraft.MixinEntityLivinBase_HidePotionParticles")
            .setSide(Side.CLIENT)
    ...
    SPEEDUP_BOP_BIOME_FOG_ACCESSOR(
        new Builder("BOP Biome Fog Accessor")
            .addMixinClass("biomesoplenty.AccessorFogHandler")
            .setSide(Side.CLIENT)
            .setApplyIf(() -> Common.config.speedupBOPFogHandling)
            .addTargetedMod(TargetedMod.BOP)),
    ...
    FIX_JOURNEYMAP_KEYBINDS(new Builder("Fix Journeymap Keybinds")
            .setSide(Side.CLIENT)
            .addMixinClass("journeymap.MixinConstants")
