...
public enum Mixins {
    ...
    FAST_CHUNK_HASHMAP(new Builder("Swaps the LongHashMap holding loaded chunks with a fastutil one")
            .setPhase(Phase.EARLY).setSide(Side.BOTH).addTargetedMod(TargetedMod.VANILLA)
            .addMixinClasses("minecraft.MixinLongHashMap").setApplyIf(() -> true)),
