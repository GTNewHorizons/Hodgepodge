...
public enum Mixins implements IMixins {
    ...
    FIX_KEYBIND_CONFLICTS(new MixinBuilder("Trigger all conflicting keybinds").setPhase(Phase.EARLY).addClientMixins("minecraft.MixinKeyBinding", "minecraft.MixinMinecraft_UpdateKeys").setApplyIf(() -> FixesConfig.triggerAllConflictingKeybindings && !doesResourceExist("committee/nova/mkb/ModernKeyBinding.class"))),
    ...
    BETTER_MOD_LIST(new MixinBuilder("Better Mod List").setPhase(Phase.EARLY).addClientMixins("fml.MixinGuiModList", "fml.MixinGuiSlotModList", "fml.MixinGuiScrollingList").setApplyIf(() -> TweaksConfig.betterModList && !doesResourceExist("com/enderio/core/common/transform/EnderCoreTransformerClient.class"))),
