...
public abstract class MixinEntityWitch {
    ...
    @WrapOperation(
            ...
            at = @At(
                    value = "NEW",
                    target = "(Lnet/minecraft/world/World;Lnet/minecraft/entity/EntityLivingBase;I)Lnet/minecraft/entity/projectile/EntityPotion;"))
    private EntityPotion changeThrownHarmingPotion(World world, EntityLivingBase witch, int meta,
