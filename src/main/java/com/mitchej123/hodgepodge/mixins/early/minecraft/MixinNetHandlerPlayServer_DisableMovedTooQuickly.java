...
public class MixinNetHandlerPlayServer_DisableMovedTooQuickly {
     ...
     * (i.e. 10 blocks/tick in a single axis). Fast-movement items like GraviChestplate combined with ThaumicBoots or
     * MPS jetpacks can legitimately exceed this threshold, causing log spam and position rollbacks.
     * <p>
