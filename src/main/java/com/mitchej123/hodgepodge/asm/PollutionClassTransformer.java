            ...
            addMethodTransformer(
                    References.cRenderBlocks.getMethod("renderBlockLiquid"), 0, new AbstractMethodTransformer() {
                        ...
                        public void transform() {
                            ...
                            insertBefore(
                                    matchVarInsn(Opcodes.ISTORE, 6),
                                    new VarInsnNode(Opcodes.ALOAD, 1), // add block
                                    new VarInsnNode(Opcodes.ILOAD, 2), // add x
                                    new VarInsnNode(Opcodes.ILOAD, 4), // add z
                                    createInvokeStatic(
                                            References.cHogClient.getMethod("renderBlockLiquid_colorMultiplier")));
                        }
                    });
            addMethodTransformer(
                    References.cRenderBlocks.getMethod("renderBlockDoublePlant"), 0, new AbstractMethodTransformer() {
                        ...
                        public void transform() {
                            ...
                            insertBefore(
                                    ...
                                    new VarInsnNode(Opcodes.ILOAD, 4), // add z
                                    createInvokeStatic(
                                            References.cHogClient.getMethod("renderBlockDoublePlant_colorMultiplier")));
                        }
                    });
            addMethodTransformer(
                    References.cRenderBlocks.getMethod("renderCrossedSquares"), 0, new AbstractMethodTransformer() {
                        ...
                        public void transform() {
                            ...
                            insertBefore(
                                    ...
                                    new VarInsnNode(Opcodes.ILOAD, 4), // add z
                                    createInvokeStatic(
                                            References.cHogClient.getMethod("renderCrossedSquares_colorMultiplier")));
                        }
                    });
            addMethodTransformer(
                            ...
                            if (optifinePresent) {
                                ...
                                insertAfter(
                                        matchMethodInsn(
                                                ...
                                                "CustomColorizer",
                                                "getColorMultiplier",
                                                "(Lnet/minecraft/block/Block;Lnet/minecraft/world/IBlockAccess;III)I"),
                                        new VarInsnNode(Opcodes.ALOAD, 1), // add block
                                        new VarInsnNode(Opcodes.ILOAD, 2), // add x
                                        new VarInsnNode(Opcodes.ILOAD, 4), // add z
                                        createInvokeStatic(
                                                References.cHogClient.getMethod("renderBlockVine_colorMultiplier")));
                            } else {
                                insertBefore(
                                        matchVarInsn(Opcodes.ISTORE, 7),
                                        new VarInsnNode(Opcodes.ALOAD, 1), // add block
                                        new VarInsnNode(Opcodes.ILOAD, 2), // add x
                                        new VarInsnNode(Opcodes.ILOAD, 4), // add z
                                        createInvokeStatic(
