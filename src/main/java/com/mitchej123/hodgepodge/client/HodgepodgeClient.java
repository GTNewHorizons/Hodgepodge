    ...
    public static void postInit() {
        ...
        if (FixesConfig.fixModlistEntries) {
            if (Compat.isIC2CropPluginPresent()) {
                final ModMetadata meta = Loader.instance().getIndexedModList().get("Ic2Nei").getMetadata();
            ...
            if (Compat.isKleeSlabsPresent()) {
                final ModMetadata meta = Loader.instance().getIndexedModList().get("kleeslabs").getMetadata();
